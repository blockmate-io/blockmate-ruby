...
module Blockmate
  ...
  class Movement
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'converted_value')
        self.converted_value = attributes[:'converted_value']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          converted_value == o.converted_value &&
          name == o.name &&
          category == o.category
    end
    ...
    def hash
      [address, currency, currency_name, currency_symbol, value, owned, fee, image_name, image_url, converted_currency, converted_value, name, category].hash
    end
