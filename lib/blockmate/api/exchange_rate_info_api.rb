...
module Blockmate
  class ExchangeRateInfoApi
    ...
    # @param pairs [String] Currency pairs for which exchange rate should be returned
    ...
    # @param days [String] Historical dates for which exchange rates should be returned
    # @param [Hash] opts the optional parameters
    # @return [Array<ExchangeRate>]
