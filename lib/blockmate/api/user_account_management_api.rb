  ...
  class UserAccountManagementApi
    ...
    def connect_account_with_http_info(account_provider, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAccountManagementApi.connect_account ...'
      end
      # verify the required parameter 'account_provider' is set
      if @api_client.config.client_side_validation && account_provider.nil?
        fail ArgumentError, "Missing the required parameter 'account_provider' when calling UserAccountManagementApi.connect_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserAccountManagementApi.connect_account",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAccountManagementApi#connect_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_account_with_http_info(account_provider, account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAccountManagementApi.delete_account ...'
      end
      # verify the required parameter 'account_provider' is set
      if @api_client.config.client_side_validation && account_provider.nil?
        fail ArgumentError, "Missing the required parameter 'account_provider' when calling UserAccountManagementApi.delete_account"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling UserAccountManagementApi.delete_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserAccountManagementApi.delete_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAccountManagementApi#delete_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_account_hint_with_http_info(account_provider, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAccountManagementApi.get_account_hint ...'
      end
      # verify the required parameter 'account_provider' is set
      if @api_client.config.client_side_validation && account_provider.nil?
        fail ArgumentError, "Missing the required parameter 'account_provider' when calling UserAccountManagementApi.get_account_hint"
      end
      # resource path
      local_var_path = '/v1/{account_provider}/connect'.sub('{' + 'account_provider' + '}', CGI.escape(account_provider.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserAccountManagementApi.get_account_hint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAccountManagementApi#get_account_hint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
